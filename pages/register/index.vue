...
<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        ...
        <img src="https://i.pinimg.com/564x/1a/6d/20/1a6d2023c84f93d7f354a5cc02535e66.jpg" alt="Background Image">
    </div>
            ...
            <el-form-item>
                    <div class="w-full flex items-center justify-between">
                        <div class="flex items-center gap-x-1 text-sm">
                            Quay lại? <nuxt-link to="/login" class="cursor-pointer text-blue-500 hover:underline"> here</nuxt-link>
                        </div>
                        <div>__</div>
                    </div>
            </el-form-item>
